...
class BackupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create backup" do
    assert_difference('Backup.count') do
      post backups_url, params: { backup: { backup_medium_id: @backup.backup_medium_id, component_id: @backup.component_id } }
    end
  ...
  test "should update backup" do
    patch backup_url(@backup), params: { backup: { backup_medium_id: @backup.backup_medium_id, component_id: @backup.component_id } }
